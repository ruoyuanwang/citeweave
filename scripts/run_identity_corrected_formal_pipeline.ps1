...
if (-not $Execute) { throw "Explicit -Execute is required after reviewing and promoting qualification." }
if ($MaximumTransportRounds -ne 10 -or $MaximumParseAttempts -ne 3) {
    throw "Frozen retry policy requires ten transport rounds and three parse attempts."
}
$mutex = [System.Threading.Mutex]::new($false, "Local\CiteWeaveIdentityCorrectedFormalDProjectBibagent")
if (-not $mutex.WaitOne(0)) { throw "Another corrected formal controller is active." }
...
function Invoke-PanelToTerminal {
    ...
    for ($round = 1; $round -le $MaximumTransportRounds; $round++) {
        ...
        Invoke-CheckedPython @("scripts\prepare_formal_v3_repair_010.py", "--verify-promoted")
...
try {
    Invoke-CheckedPython @("scripts\prepare_formal_v3_repair_010.py", "--verify-promoted")
    $primaryPlan = "experiments\graph_discovery_v2\formal_v3_identity_corrected_execution\primary_plan.json"
    $replicationPlan = "experiments\graph_discovery_v2\formal_v3_identity_corrected_execution\replication_plan.json"
    $extensionPlan = "experiments\graph_discovery_v2\formal_v3_identity_corrected_execution\extension_plan.json"
    ...
    Invoke-PanelToTerminal -PanelName "primary" -PlanPath $primaryPlan `
        ...
        -RunnerArguments @(
            ...
            "--readiness", "experiments\graph_discovery_v2\formal_v3_identity_corrected_execution\primary_readiness.json",
    ...
    Invoke-PanelToTerminal -PanelName "replication" -PlanPath $replicationPlan `
        ...
        -RunnerArguments @(
            ...
            "--readiness", "experiments\graph_discovery_v2\formal_v3_identity_corrected_execution\replication_readiness.json",
            "--api-key-file", $apiKeyFile,
            "--execute"
        )
    Invoke-PanelToTerminal -PanelName "complexity_extension_incremental" -PlanPath $extensionPlan `
        ...
        -RunnerArguments @(
            ...
            "--readiness", "experiments\graph_discovery_v2\formal_v3_identity_corrected_execution\extension_readiness.json",
            "--api-key-file", $apiKeyFile,
            "--execute"
        )
    ...
    Invoke-CheckedPython @(
        ...
        "--readiness", "experiments\graph_discovery_v2\formal_v3_identity_corrected_execution\extension_readiness.json",
        "--benchmark-root", "experiments\graph_discovery_v2\formal_v3_complexity_extension_benchmarks",
        "--primary-benchmark-root", "experiments\graph_discovery_v2\formal_v3_identity_corrected_benchmarks",
    ...
    Invoke-CheckedPython @(
        ...
        "--protocol", "experiments\graph_discovery_v2\formal_v3_protocol.yml",
        "--neural-amendment", "experiments\graph_discovery_v2\formal_v3_amendment_002_neural_dense.yml",
        "--statistics-amendment", "experiments\graph_discovery_v2\formal_v3_identity_corrected_statistics_v2\statistics.yml",
        "--scale-pairs", "experiments\graph_discovery_v2\formal_v3_identity_corrected_statistics_v2\scale_pairs.json",
        "--benchmark-root", "experiments\graph_discovery_v2\formal_v3_identity_corrected_benchmarks",
        "--results-root", "experiments\graph_discovery_v2\formal_v3_runs",
        "--weighting-amendment", "experiments\graph_discovery_v2\formal_v3_analysis_amendment_007_equal_dataset_weighting.yml",
        "--weighting-amendment-freeze", "experiments\graph_discovery_v2\formal_v3_analysis_amendment_007_equal_dataset_weighting_freeze.json",
    ...
    Invoke-CheckedPython @(
        ...
        "--primary-benchmark-root", "experiments\graph_discovery_v2\formal_v3_identity_corrected_benchmarks",
        "--primary-results-root", "experiments\graph_discovery_v2\formal_v3_runs",
        "--primary-scale-pairs", "experiments\graph_discovery_v2\formal_v3_identity_corrected_statistics_v2\scale_pairs.json",
        "--replication-benchmark-root", "experiments\graph_discovery_v2\formal_v3_replication_benchmarks",
        "--replication-results-root", "experiments\graph_discovery_v2\formal_v3_replication_runs",
    ...
    Invoke-CheckedPython @(
        ...
        "--analysis-amendment", "experiments\graph_discovery_v2\formal_v3_complexity_analysis_amendment_008_cluster_validity.yml",
        "--analysis-amendment-freeze", "experiments\graph_discovery_v2\formal_v3_complexity_analysis_amendment_008_cluster_validity_freeze.json",
